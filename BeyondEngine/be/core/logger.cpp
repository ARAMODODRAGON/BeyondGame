...
namespace be {
	...
	const std::string& logger::get_log_path() {
		if (s_logFilepath == "") {
	...
	void logger::log(const std::string& msg, const std::string& file, size_t line) {
	...
	void logger::trace(const std::string& msg, const std::string& file, size_t line) {
		mutex_guard mg(s_lock);
		// open file at the end
		std::ofstream filestream;
		filestream.open(get_log_path(), std::ios::app);
	...
	void logger::warning(const std::string& msg, const std::string& file, size_t line) {
		mutex_guard mg(s_lock);
		// open file at the end
		std::ofstream filestream;
		filestream.open(get_log_path(), std::ios::app);
	...
	void logger::error(const std::string& msg, const std::string& file, size_t line) {
		mutex_guard mg(s_lock);
		// open file at the end
		std::ofstream filestream;
		filestream.open(get_log_path(), std::ios::app);
	...
	void logger::fatal_error(const std::string& msg, const std::string& file, size_t line) {
		mutex_guard mg(s_lock);
		// open file at the end
		std::ofstream filestream;
		filestream.open(get_log_path(), std::ios::app);
